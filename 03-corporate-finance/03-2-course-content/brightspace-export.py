...
─── USAGE ───────────────────────────────────────────────────────────────────
  ...
  python3 03-corporate-finance/03-2-course-content/brightspace-export.py --modules 2 3
  python3 03-corporate-finance/03-2-course-content/brightspace-export.py --dry-run
  python3 03-corporate-finance/03-2-course-content/brightspace-export.py --toc-only
...
CF_MODULES = REPO_ROOT / "03-corporate-finance" / "03-2-course-content"
CF_BLOGS = REPO_ROOT / "03-corporate-finance" / "03-4-blogs" / "posts"

MODULE_DIRS = {
    1: "01-foundations-and-discount-rates",
    2: "02-investment-returns-and-financing",
    3: "03-financing-mix-and-dividends",
    4: "04-dividends-and-valuation",
}

LESSON_MODULE_MAP = {
    **{n: MODULE_DIRS[1] for n in range(1, 13)},
    **{n: MODULE_DIRS[2] for n in range(13, 20)},
    **{n: MODULE_DIRS[3] for n in range(20, 27)},
    **{n: MODULE_DIRS[4] for n in range(27, 37)},
}
...
def process_lesson(
    ...
    mod = LESSON_MODULE_MAP.get(lesson_num, MODULE_DIRS[1])
...
def main():
    ...
    if args.lesson:
        ...
        allowed = {MODULE_DIRS[m] for m in args.modules if m in MODULE_DIRS}
    ...
    if not args.force:
        ...
        lesson_nums = [
            ...
            if not (CF_MODULES / LESSON_MODULE_MAP.get(n, MODULE_DIRS[1]) / f"lesson-{n:02d}" / "lesson-overview.md").exists()
        ]
