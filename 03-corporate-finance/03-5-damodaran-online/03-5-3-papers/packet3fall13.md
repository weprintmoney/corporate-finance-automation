...
source_url: https://www.stern.nyu.edu/~adamodar/pdfiles/eqnotes/packet3fall13.pdf
---
...
### When is there an opQon embedded in an acQon?
...
## Payoff Diagram on Put OpQon

![](_page_8_Diagram_2.jpeg)

### When does the opQon have significant economic value?
...
### When can you use opQon pricing models to value real opQons?
...
## The Binomial OpQon Pricing Model

![](_page_13_Diagram_2.jpeg)

## The LimiQng DistribuQons….
...
## Choice of OpQon Pricing Models
...
### A decision tree valuaQon of a pharmaceuQcal company with one drug in the FDA pipeline…

![](_page_21_Diagram_2.jpeg)

## Key Tests for Real OpQons
...
## Valuing the OpQon to Delay a Project
...
- □ If  $V$  is the present value of the costs of developing the product, and  $V$  is the present value of the expected cashflows from development, the payoffs from owning a product patent can be written as:

$$\begin{aligned} \text{Payoff from owning a product patent} &= V - I & \text{if } V > I \\ &= 0 & \text{if } V \leq I \end{aligned}$$

## Payoff on Product OpQon

![](_page_27_Diagram_2.jpeg)

## Obtaining Inputs for Patent ValuaQon
...
### The Real OpQons Test: Patents and Technology
...
$$\begin{aligned}\text{Payoff on natural resource investment} &= V - X & \text{if } V > X \\ &= 0 & \text{if } V \leq X\end{aligned}$$

## Payoff Diagram on Natural Resource Firms

![](_page_38_Diagram_2.jpeg)

### EsQmaQng Inputs for Natural Resource OpQons
...
### Pu|ng Natural Resource OpQons to the Test
...
### ¨ Real opQon pricing models work well with natural resource opQons.

## The OpQon to Expand/Take Other Projects
...
## B. The OpQon to Expand

![](_page_45_Diagram_2.jpeg)

### The opQon to expand: Valuing a young, start-‐up company
...
### A note of cauQon: OpportuniQes are not opQons…

![](_page_48_Diagram_2.jpeg)

### The Real OpQons Test for Expansion OpQons
...
### ¨ Using opQon pricing models to value expansion opQons will not only yield extremely noisy esQmates, but may aaach inappropriate premiums to discounted cashflow esQmates.

## C. The OpQon to Abandon
...
Value of Put = 
$$\text{Ke}^{-rt} (1-N(d2)) - \text{Se}^{-yt} (1-N(d1))$$
...
### ImplicaQons for Investment Analysis/ ValuaQon
...
## Inputs to OpQon ValuaQon Model-‐ Disney
...
## Payoff Diagram for LiquidaQon OpQon

![](_page_63_Figure_2.jpeg)

## ApplicaQon to valuaQon: A simple example
...
## Valuing Equity as a Call OpQon
...
## The Value of Equity as an OpQon
...
## Valuing Equity awer the Project
...
### Obtaining opQon pricing inputs -‐ Some real world problems
...
### Valuing Equity as an opQon -‐ Eurotunnel in early 1998
...
- ❑ Value of the call =  $2312 (0.2023) - 8,865 \exp^{(-0.06)(10.93)} (0.0751) = \text{£122 million}$
...
### And the long-‐term follow up is not posiQve either..
...
### Growing through acquisiQons seems to be a "loser' s game "
...
### Lesson 1: Don't transfer your risk characterisQcs to the target firm
...
| Year      | Deprec'n | Deprec'n | Change	  in | Tax	  Savings | PV	  @	  14.5% |
|-----------|----------|----------|--------------|----------------|------------------|
|           | before   | awer     | Deprec'n     |                |                  |
...
## Test 5: Comparables and Exit MulQples
...
### Test 6: The CEO really wants to do this… or there are compeQQve pressures…
...
### Lesson 6: Don't let egos or investment bankers get the beaer of common sense…
...
### To illustrate: A bad deal is made, and jusQfied by accountants & bankers
...
### Beaer to lose a bidding war than to win one…
...
### Lesson 7: For acquisiQons to create value, you have to stay disciplined..
...
### Value CreaQon 1: Increase Cash Flows from Assets in Place

![](_page_125_Diagram_2.jpeg)

### Value CreaQon 2: Increase Expected Growth

**127**

![](_page_126_Diagram_5.jpeg)
...
### III. Building CompeQQve Advantages: Increase length of the growth period

![](_page_128_Diagram_2.jpeg)

## Value CreaQon 4: Reduce Cost of Capital
...
g = 3.41%; Beta = 1.00; Debt Ratio= 20% Cost of capital = 6.62% ROC= 6.62%; Tax rate=35% Reinvestment Rate=51.54%
...
| Op. Assets         | 38045 |            | First 5 years |       |       |       | Growth decreases gradually to 3.41% |       |       |       |       | Term Yr |
|--------------------|-------|------------|---------------|-------|-------|-------|-------------------------------------|-------|-------|-------|-------|---------|
| + Cash:            | 3,018 |            |               |       |       |       |                                     |       |       |       |       |         |
| - Debt             | 558   |            |               |       |       |       |                                     |       |       |       |       |         |
| - Pension Lian     | 305   |            |               |       |       |       |                                     |       |       |       |       |         |
...
| Value/Share 126.51 |       | = FCFF     | 484           | 552   | 629   | 717   | 817                                 | 1,036 | 1,271 | 1,512 | 1,747 | 1,963   |
...
![](_page_135_Diagram_3.jpeg)

### Why the probability of management changing shiws over Qme….
...
## EsQmaQng the Probability of Change
...
## ManifestaQons of the Value of Control
...
### 3. VoQng and Non-‐voQng Shares: An Example
...
### AlternaQve Approaches to Value Enhancement
