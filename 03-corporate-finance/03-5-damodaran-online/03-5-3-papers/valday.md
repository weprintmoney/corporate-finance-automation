...
source_url: https://www.stern.nyu.edu/~adamodar/pdfiles/country/valday.pdf
---
...
- Adjusted Equity Spread = 4.83% (30.64%/15.28%) = 9.69% n Ratings agencies make mistakes. They are often late in recognizing and building in risk.
...
n ROC = EBIT (1- tax rate) / (BV of Debt + BV of Equity) = 1395/12,006= 11.62% n Reinv. Rate = (Net Cap Ex + Chg in WC)/EBIT (1-t) = (1012+290)/ 1395 = 93.28% n Expected Growth Rate = (.1162)\*(.9328) = 10.84%
...
**Risk Premium** 4.00% Mature risk premium 4% Country Risk Premium 0.00%
