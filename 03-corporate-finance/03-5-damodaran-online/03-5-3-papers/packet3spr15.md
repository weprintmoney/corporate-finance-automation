...
source_url: https://www.stern.nyu.edu/~adamodar/pdfiles/eqnotes/packet3spr15.pdf
---
...
# Choice of OpRon Pricing Models
...
### A decision tree valuaRon of a pharmaceuRcal company with one drug in the FDA pipeline…

![](_page_21_Diagram_2.jpeg)

# Key Tests for Real OpRons
...
# Valuing the OpRon to Delay a Project

![](_page_25_Diagram_2.jpeg)

### Example 1: Valuing product patents as opRons
...
# Payoff on Product OpRon

![](_page_27_Diagram_2.jpeg)

# Obtaining Inputs for Patent ValuaRon
...
### The Real OpRons Test: Patents and Technology
...
### Example 2: Valuing Natural Resource OpRons
...
### EsRmaRng Inputs for Natural Resource OpRons
...
### Pu|ng Natural Resource OpRons to the Test
...
### ¨ Real opRon pricing models work well with natural resource opRons.

# The OpRon to Expand/Take Other Projects
...
# B. The OpRon to Expand

![](_page_45_Diagram_2.jpeg)

### The opRon to expand: Valuing a young, start-‐up company
...
### A note of cauRon: OpportuniRes are not opRons…

![](_page_48_Diagram_2.jpeg)

### The Real OpRons Test for Expansion OpRons
...
### ¨ Using opRon pricing models to value expansion opRons will not only yield extremely noisy esRmates, but may abach inappropriate premiums to discounted cashflow esRmates.

# C. The OpRon to Abandon
...
### ImplicaRons for Investment Analysis/ ValuaRon
...
# Inputs to OpRon ValuaRon Model-‐ Disney
...
# Payoff Diagram for LiquidaRon OpRon

![](_page_63_Figure_2.jpeg)

# ApplicaRon to valuaRon: A simple example
...
# Valuing Equity as a Call OpRon
...
# The Value of Equity as an OpRon
...
### Obtaining opRon pricing inputs -‐ Some real world problems
...
### Valuing Equity as an opRon -‐ Eurotunnel in early 1998
...
### And the long-‐term follow up is not posiRve either..
...
### Growing through acquisiRons seems to be a "loser' s game "
...
### Lesson 1: Don't transfer your risk characterisRcs to the target firm
...
# Test 5: Comparables and Exit MulRples
...
### Test 6: The CEO really wants to do this… or there are compeRRve pressures…
...
### Lesson 6: Don't let egos or investment bankers get the beber of common sense…
...
### To illustrate: A bad deal is made, and jusRfied by accountants & bankers
...
### Beber to lose a bidding war than to win one…
...
### Lesson 7: For acquisiRons to create value, you have to stay disciplined..
...
### Value CreaRon 1: Increase Cash Flows from Assets in Place

![](_page_125_Diagram_2.jpeg)

### Value CreaRon 2: Increase Expected Growth
...
### III. Building CompeRRve Advantages: Increase length of the growth period

![](_page_128_Diagram_2.jpeg)

# Value CreaRon 4: Reduce Cost of Capital
...
### Why the probability of management changing shiws over Rme….
...
# EsRmaRng the Probability of Change
...
# ManifestaRons of the Value of Control
...
### 3. VoRng and Non-‐voRng Shares: An Example
...
### AlternaRve Approaches to Value Enhancement
