...
source_url: https://www.stern.nyu.edu/~adamodar/pdfiles/eqnotes/packet1spr13.pdf
---
...
$$\text{Value of asset} = \frac{\text{CE(CF}_1)}{(1+r_f)} + \frac{\text{CE(CF}_2)}{(1+r_f)^2} + \frac{\text{CE(CF}_3)}{(1+r_f)^3} \dots + \frac{\text{CE(CF}_n)}{(1+r_f)^n}$$
...
| CroaJa          | 4.95%           | 7.41%       | Germany           | 1.31%          | 1.92%          |
...
| 101              | Americas       |  | 1289.46   | -30.2  | -30.28 | -0.1 | 742.8 | -   | 3542.9 | 1165.5 | +123.9 | +374.0 |
| 102              | Argentina      |  |           |        |        |      |       |     |        |        |        |        |
...
| Latin America 47 | 3.38% Aswath Damodaran | 9.18%  |
...
## EsJmaJng Lambdas: The Revenue Approach
...
$$\lambda$$
 = % of revenues domestically firm/ % of revenues domestically average firm
...
![](_page_74_Figure_39.jpeg)

# Beta Estimation: The Index Effect

![](_page_75_Figure_40.jpeg)
...
### Default Spreads: The effect of the crisis of 2008.. And the alermath
...
Investment in Existing Projects \$ 1000

Current Return on Investment on Projects 12% X =

Current Earnings \$120

Investment in Existing Projects \$1000

Next Period's Return on Investment 12%

X

Investment in New Projects \$100

Return on Investment on New Projects 12% + <sup>X</sup> <sup>=</sup>

Next Period's Earnings 132
...
Return on Investment on New Projects 12% + <sup>X</sup> Change in Earnings
...
$$= \text{ROC}_{\text{Current}}^{\text{New Investments}} [1 + \text{ROC}_{\text{Current}}^{\text{In 5 years}} - \text{ROC}_{\text{Current}}^{\text{Reinvestment Rate}}) / \text{ROC}_{\text{Current}}^{\text{Reinvestment Rate}}$$
...
| Choose a                                     | Cashflows to Firm                                                                                                                                            |
|----------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Cash Flow Expected Dividends to Stockholders | Dividends Cashflows to Equity Net Income EBIT (1- tax rate) - (Capital Exp. - Deprec’n)                                                                      |
|                                              | - (1- δ ) (Capital Exp. - Deprec’n) - Change in Work. Capital                                                                                                |
|                                              | - (1- δ ) Change in Work. Capital = Free Cash flow to Firm (FCFF) = Free Cash flow to Equity (FCFE)                                                          |
|                                              | [ δ = Debt Ratio]                                                                                                                                            |
| & A Discount Rate                            | Cost of Equity Cost of Capital WACC = ke ( E/ (D+E))                                                                                                         |
| Basis Models:                                | : The riskier the investment, the greater is the cost of equity. + kd ( D/(D+E)) CAPM: Riskfree Rate + Beta (Risk Premium) kd = Current Borrowing Rate (1-t) |
|                                              | APM: Riskfree Rate + Σ Betaj                                                                                                                                 |
| & a growth pattern g                         | ): n factors (Risk Premiumj E,D: Mkt Val of Equity and Debt Stable Growth Two-Stage Growth Three-Stage Growth g g                                            |
|                                              | High Growth Stable                                                                                                                                           |
|                                              | High Growth Transition Stable t                                                                                                                              |
...
### A Premium for Marketable SecuriJes: Berkshire Hathaway
...
#### ¨ In Discounted Cashflow ValuaJon
...
![](_page_233_Diagram_4.jpeg)

#### *From a Company to the Market: Valuing the S&P 500: Dividend Discount Model in January 2013*
...
![](_page_234_Diagram_4.jpeg)

#### *From a Company to the Market: Valuing the S&P 500: Augmented Dividend Discount Model in January 2013*

#### **Rationale for model**

Why dividends & buybacks? Because more and more companies are chosing to return cash in the form of buybacks

Why 2-stage? Because the expected growth rate in near term is higher than stable growth rate.

![](_page_235_Diagram_3.jpeg)

#### *Valuing the S&P 500: Augmented Dividends & Fundamental Growth Model in January 2013*

#### **Rationale for model**

Why dividends & buybacks? Because more and more companies are chosing to return cash in the form of buybacks Why 2-stage? Because the expected growth rate in near term is higher than stable growth rate.
...
![](_page_242_Diagram_1.jpeg)

# Lesson 1: Don't trust regression betas....

![](_page_243_Figure_39.jpeg)
...
| <b>Value of operating assets</b>          |                              |                      |        |                   |              |         |                 |               | <b>\$5,475</b> |
| <b>(Add) Cash</b>                         |                              |                      |        |                   |              |         |                 |               | <b>\$155</b>   |
| <b>(Subtract) Debt</b>                    |                              |                      |        |                   |              |         |                 |               | <b>\$491</b>   |
| <b>(Subtract) Management Options</b>      |                              |                      |        |                   |              |         |                 |               | <b>\$53</b>    |
| <b>Value of equity in common stock</b>    |                              |                      |        |                   |              |         |                 |               | <b>\$5,085</b> |
| <b>Value per Asset of South Damodaran</b> |                              |                      |        |                   |              |         |                 |               | <b>\$37,80</b> |
...
![](_page_273_Diagram_2.jpeg)

![](_page_273_Diagram_4.jpeg)

![](_page_273_Diagram_6.jpeg)

![](_page_273_Diagram_8.jpeg)
...
$$FCF_{Bank} = \text{Net Income} - \text{Increase in Regulatory Capital (Book Equity)}$$
...
**292** Normalized cost of capital (3)  
...
![](_page_304_Figure_15.jpeg)

![](_page_304_Figure_16.jpeg)

![](_page_304_Figure_17.jpeg)

![](_page_304_Figure_18.jpeg)

![](_page_304_Figure_19.jpeg)
