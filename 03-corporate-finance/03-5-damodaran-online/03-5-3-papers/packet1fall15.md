...
source_url: https://www.stern.nyu.edu/~adamodar/pdfiles/eqnotes/packet1fall15.pdf
---
...
## Discounted Cash Flow ValuaIon: The Steps
...
## Moving on up: The "potenIal dividends" or FCFE model

![](_page_16_Diagram_2.jpeg)

## To valuing the enIre business: The FCFF model
...
# EsImaIng Inputs: Discount Rates
...
## The Cost of Equity: CompeIng " Market Risk" Models
...
## Sovereign Default Spread: Three paths to the same desInaIon…
...
| ArgenIna          | Caa1    | 83.48%        | 83.17%           | Iceland        | Baa3    | 2.27%         | 1.96%            | Portugal                          | Ba1     | 3.09%         | 2.78%         |
...
| CroaIa            | Ba1     | 3.65%         | 3.34%            | Lithuania      | Baa1    | 1.88%         | 1.57%            | Thailand                          | Baa1    | 1.91%         | 1.60%         |
...
## No default free enIty: Choices with riskfree rates….
...
# Some perspecIve on risk free rates
...
## The simplest way of esImaIng an addiIonal country risk premium: The country default spread
...
## An equity volaIlity based approach to esImaIng the country total ERP
...
## A melded approach to esImaIng the addiIonal country risk premium
...
- ❑ Another is to multiply the bond default spread by the relative volatility of stock and bond prices in that market. Using this approach for Brazil in January 2015, you would get:
...
| CroaIa         | 9.50%  | 3.75% | Slovenia     | 9.50%  | 3.75%  |
...
## Approaches 1 & 2: EsImaIng country risk premium exposure
...
## OperaIon based CRP: Single versus MulIple Emerging Markets
...
## Extending to a mulInaIonal: Regional breakdown Coca Cola's revenue breakdown and ERP in 2012
...
## Approach 3: EsImate a lambda for country risk
...
## EsImaIng Company Exposure to Country Risk
...
## A richer lambda esImate: Use stock returns and country bond "returns": EsImaIng a "lambda" for Embraer in 2004
...
## EsImaIng a US Dollar Cost of Equity for Embraer -‐ September 2004
...
# The evoluIon of Emerging Market Risk
...
![](_page_77_Figure_34.jpeg)

## Stock-‐priced based soluIons to the Regression Beta Problem
...
## AlternaIve measures of relaIve risk for equity
...
# Determinants of Betas & RelaIve Risk
...
# AdjusIng for operaIng leverage…
...
## EsImaIng BoQom Up Betas & Costs of Equity: Vale
...
## Interest Coverage RaIos, RaIngs and Default Spreads: 2003 & 2004
...
## Default Spreads: The effect of the crisis of 2008.. And the aoermath
...
## If you had to do it….ConverIng a Dollar Cost of Capital to a Nominal Real Cost of Capital
...
# II. CorrecIng AccounIng Earnings
...
# OperaIng Leases at The Gap in 2003
...
## The Collateral Effects of TreaIng OperaIng Leases as Debt
...
## V. Dealing with NegaIve or Abnormally Low Earnings
...
# Working Capital: General ProposiIons
...
# EsImaIng FCFE when Leverage is Stable
...
# Ways of EsImaIng Growth in Earnings
...
## Motorola: ArithmeIc versus Geometric Growth Rates
...
## How good are analysts at forecasIng growth?
...
# ProposiIons about Analyst Growth Rates
...
## EsImaIng Fundamental Growth from new investments: Three variaIons
...
## EsImaIng Expected Growth in EPS: Wells Fargo in 2008
...
## EsImaIng expected growth in net income from non-‐cash assets: Coca Cola in 2010
...
# EsImaIng Growth in OperaIng Income
...
## IV. OperaIng Income Growth when Return on Capital is Changing
...
## V. EsImaIng Growth when OperaIng Income is NegaIve or Margins are changing
...
| Year Current 1 2 3 4 | Revenue Growth 200.00% 100.00% 80.00% 60.00% | Revenue \$ \$187 \$562 \$1,125 \$2,025 \$3,239 | OperaIng Margin -­‐419.92% -­‐199.96% -­‐89.98% -­‐34.99% -­‐7.50% | OperaIng Income -­‐\$787 -­‐\$1,125 -­‐\$1,012 -­‐\$708 -­‐\$243 |
|----------------------|----------------------------------------------|------------------------------------------------|--------------------------------------------------------------------|------------------------------------------------------------------|
...
$$\text{Value} = \sum_{t=1}^{\infty} \frac{CF_t}{(1+r)^t} + \frac{\text{Terminal Value}}{(1+r)^N}$$

# Ways of EsImaIng Terminal Value
...
## And the key determinant of growth periods is the company's compeIIve advantage…
...
# Which Growth PaQern Should I use?
...
# The Building Blocks of ValuaIon

| <b>Choose a</b>    |                                                                                                                                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                             |                                                                                                                                                                                                                                                                                                                                             |
|--------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Cash Flow          | <i>Dividends</i>                                                                                                                                                                                                                                                                                                                                                         | <i>Cashflows to Equity</i>                                                                                                                                                                                                                                                                                                                                                  | <i>Cashflows to Firm</i>                                                                                                                                                                                                                                                                                                                    |
|                    | Expected Dividends to Stockholders                                                                                                                                                                                                                                                                                                                                       | Net Income<br>- (1- δ) (Capital Exp. - Deprec'n)<br>- (1- δ) Change in Work. Capital<br>= Free Cash flow to Equity (FCFE)<br>[δ = Debt Ratio]                                                                                                                                                                                                                               | EBIT (1- tax rate)<br>- (Capital Exp. - Deprec'n)<br>- Change in Work. Capital<br>= Free Cash flow to Firm (FCFF)                                                                                                                                                                                                                           |
| & A Discount Rate  | <i>Cost of Equity</i>                                                                                                                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                                                                                                                             | <i>Cost of Capital</i>                                                                                                                                                                                                                                                                                                                      |
|                    | <ul> <li><i>Basis</i>: The riskier the investment, the greater is the cost of equity.</li> <li><i>Models</i>:<br/>CAPM: Riskfree Rate + Beta (Risk Premium)<br/>APM: Riskfree Rate + Σ Beta<sub>j</sub> (Risk Premium<sub>j</sub>): <i>n factors</i></li> </ul>                                                                                                          | WACC = k <sub>e</sub> ( E/ (D+E))<br>+ k <sub>d</sub> ( D/(D+E))<br>k <sub>d</sub> = Current Borrowing Rate (1-t)<br>E,D: Mkt Val of Equity and Debt                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                             |
| & a growth pattern | <i>Stable Growth</i>                                                                                                                                                                                                                                                                                                                                                     | <i>Two-Stage Growth</i>                                                                                                                                                                                                                                                                                                                                                     | <i>Three-Stage Growth</i>                                                                                                                                                                                                                                                                                                                   |
|                    | <img alt="Stable Growth graph with two stages: High Growth (t=0) and Stable Growth (t=t). The High Growth stage is a horizontal line at a constant return rate g. The Stable Growth stage is a horizontal line at a stable return rate g. The two stages are connected by a diagonal line with a step decrease from the high growth stage to the stable growth stage."/> | <img alt="Two-Stage Growth graph with two stages: High Growth (t=0) and Stable Growth (t=t). The High Growth stage is a horizontal line at a constant return rate g. The Stable Growth stage is a horizontal line at a stable return rate g. The two stages are connected by a diagonal line with a step decrease from the high growth stage to the stable growth stage."/> | <img alt="Three-Stage Growth graph with three stages: High Growth (t=0), Transition (t=t), and Stable Growth (t=t). The High Growth stage is a horizontal line at a constant return rate g. The Transition stage is a horizontal line at a stable return rate g. The Stable Growth stage is a horizontal line at a stable return rate g."/> |
...
## A Simple ExplanaIon for the Closed End Discount
...
# More on Cross Holding ValuaIon
...
## If you have to seQle for an approximaIon, try this…
...
# 6. Equity OpIons issued by the firm..
...
## Why do opIons affect equity value per share?
...
## Dealing with Employee OpIons: The Bludgeon Approach
...
# Dealing with opIons the right way…
...
## Valuing Equity OpIons issued by firms… The DiluIon Problem
...
## Back to the numbers… Inputs for OpIon valuaIon
...
## When opIons affect equity value per share the most…
...
## Step 2: Check the narraIve against history, economic first principles & common sense

![](_page_233_Diagram_2.jpeg)

## Step 3: Connect your narraIve to key drivers of value
...
## Step 6: Be ready to modify narraIve as events unfold
...
# Equity Risk Premiums in ValuaIon
...
## Lesson 5: And don't worry about diluIon… It is already factored in
...
## Lesson 6: There are always scenarios where the market price can be jusIfied…
...
## Lesson 7: You will be wrong 100% of the Ime… and it really is not (always) your fault…
...
# II. Mature Companies in transiIon..
...
| Total Value per Asset of South Damodaran |                              |                      |        |                   |              |         |                 | \$37,80       |
...
## Lesson 2: Increasing growth is not always a value creaIng opIon.. And it may destroy value at Imes..
...
# AdjusIng the value of LVS for distress..
...
# Lesson 2: Currency should not maQer
...
## Lesson 5: TruncaIon risk can come in many forms…
...
## Lesson 2: For financial service companies, book value maQers…
...
$$\text{FCFE}_{\text{Bank}} = \text{Net Income} - \text{Increase in Regulatory Capital (Book Equity)}$$
...
## Lesson 1: AccounIng rules are cluQered with inconsistencies…
...
## Lesson 1: With "macro" companies, it is easy to get lost in "macro" assumpIons…
...
## Lesson 2: Use probabilisIc tools to assess value as a funcIon of macro variables…
...
# Exxon Mobil ValuaIon: SimulaIon
