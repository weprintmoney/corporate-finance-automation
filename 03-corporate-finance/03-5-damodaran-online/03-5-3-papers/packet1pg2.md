...
source_url: https://www.stern.nyu.edu/~adamodar/pdfiles/eqnotes/packet1pg2.pdf
---
...
$$\text{Value of asset} = \frac{\text{CE}(\text{CF}_1)}{(1+r_e)} + \frac{\text{CE}(\text{CF}_2)}{(1+r_e)^2} + \frac{\text{CE}(\text{CF}_3)}{(1+r_e)^3} + \dots + \frac{\text{CE}(\text{CF}_n)}{(1+r_e)^n}$$
...
|           | <b>Armither Avenge</b> |                   | <b>Geometric Average</b> |                   | <b>Geometric Average</b> |
|-----------|------------------------|-------------------|--------------------------|-------------------|--------------------------|
| 1928-2010 | Stocks - T. Bills      | Stocks - T. Bonds | Stocks - T. Bills        | Stocks - T. Bonds | Stocks - T. Bonds        |
|           | 2.62%                  | 6.03%             | 5.67%                    | 4.31%             |                          |
|           | 2.25%                  | 2.38%             |                          |                   |                          |
...
- | <ul> Brazil ■ Rared B2 with Woody Cooling of the default freed from the Brazilian dollar denominated C.Bond at the end of August 2004 was 6.01%. (10.30%-4.29%) </ul> <p>■ <i>Relative Equity Market approach:</i> The country equity risk premium is based upon the volatility of the market in question relative to U.S market.</p> <ul> Total equity risk premium = Risk Premium<sub>US</sub> * <math>\sigma_{\text{Country Equity}} / \sigma_{\text{US Equity}}</math> </ul> <p>Using a 4.82% premium for the US (the historical premium from 1928-2003), this approach would yield:</p> <ul> Total risk premium for Brazil = 4.82% (34.56%/19.01%) = 8.76% Country equity risk premium for Brazil = 8.76% - 4.82% = 3.94% </ul> <p>(The standard deviation in weekly returns from 2002 to 2004 for the Bovespa was 34.56% whereas the standard deviation in the S&amp;P 500 was 19.01%)</p> |
  |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
$$1.468.36 = \frac{1.19}{(1+r)} + \frac{6.08}{(1+r)^2} + \frac{6.33}{(1+r)^3} + \frac{7.17}{(1+r)^4} + \frac{7.34}{(1+r)^5} + \frac{7.35(1.0402)}{(1+r)^6}$$
...
# Equity Risk Premium: A January 2011 update
 ...
 By January 1, 2011, the worst of the crisis seemed to be behind us. Fears of a depression had receded and banks looked like they were struggling back to a more stable setting. Default spreads started to drop and risk was no longer

front and center in pricing. *In 2010, the actual cash returned to stockholders was 53.96. That was up about 30% from 2009 levels.*
...
$$15446 = \frac{57.06}{(1+r)} + \frac{612.25}{(1+r)^2} + \frac{697.86}{(1+r)^3} + \frac{795.67}{(1+r)^4} + \frac{907.07}{(1+r)^5} + \frac{907.07(1.0676)}{(1+r)^6}$$
...
### $$\sqrt{\text{Number of firms in sample}}$$
...
In computing the cost of capital for a publicly traded firm, the general rule for computing weights for debt and equity is that you use market value weights (and not book value weights). Why? Because the market is usually right Because market values are easy to obtain Because book values of debt and equity are meaningless None of the above
...
$$(1 + \text{Cost of Capital}_{\text{S}}) \left[ \frac{1 + \text{Inflation}_{\text{BR}}}{1 + \text{Inflation}_{\text{S}}} \right] = 1.0997 (1.08/1.02) - 1 = 0.1644 \text{ or } 16.44\%$$
...
| Cost of capital = 8.20%(7350/9320) + 4% (1970/9320) = 7.31%<br>Cost of equity for The Gap = 8.20%<br>After-tax cost of debt = 4%<br>Market value of equity = 7350 | Cost of capital = 8.20%(7350/1371) + 4% (6367/1371) = 6.25%                                                     |
...
# Estimating FCFE: Disney
 ...
 Net Income=\$ 1533 Million Capital spending = \$ 1,746 Million Depreciation per Share = \$ 1,134 Million Increase in non-cash working capital = \$ 477 Million Debt to Capital Ratio = 23.83%
...
|---------------------|-----------|----------|----------|----------|----------|----------|----------|
| 1994                | \$ 22,245 |          | % Change | \$ 4,151 |          | \$ 2,604 | % Change |
| 1995                | \$ 27,037 | 21.54%   |          | \$ 4,850 |          | \$ 2,961 | -12.5%   |
| 1996                | \$ 27,973 | 3.46%    |          | \$ 4,268 | -12.00%  | \$ 2,930 | -33.31%  |
| 1997                | \$ 29,794 | 6.51%    |          | \$ 4,276 | 0.19%    | \$ 1,947 | -0.66%   |
| 1998                | \$ 29,398 | -1.33%   |          | \$ 3,019 | -29.40%  | \$ 822   | -27.9%   |
| 1999                | \$ 30,931 | 5.21%    |          | \$ 5,838 | 78.80%   | \$ 3,216 | -59.24%  |
| Arthritetic Average |           | 7.08%    |          |          | 10.89%   |          | 42.45%   |
| General Average     |           | 6.82%    |          |          | 5.39%    |          | 4.71%    |
| Standard deviation  |           | 8.61%    |          |          | 41.56%   |          | 14.71%   |
...
| ROIC on existing investments after  | 10.00%        | 10.00%        | 10.00%        | 10.80%        | 10.00%        |
|                                     |               |               |               |               |               |
...
- When a firm's cash flows grow at a "constant" rate forever, the present value of those cash flows can be written as: Value = Expected Cash Flow Next Period / (r - g) where, r = Discount rate (Cost of Equity or Cost of Capital) g = Expected growth rate The stable growth rate cannot exceed the growth rate of the economy but it can be set lower.
...
| Choose a           |                                                                                                                                                                                                                                                                                           |                                                                                                                                                                                                       |                                                                                                                                                |
|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
| Cash Flow          | <i>Dividends</i><br>Expected Dividends to Stockholders                                                                                                                                                                                                                                    | <i>Cashflows to Equity</i><br>Net Income<br>- (1 - $\delta$ ) (Capital Exp. - Deprec'n)<br>- (1 - $\delta$ ) Change in Work. Capital<br>= Free Cash flow to Equity (FCFE)<br>[ $\delta$ = Debt Ratio] | <i>Cashflows to Firm</i><br>EBIT (1 - tax rate)<br>- (Capital Exp. - Deprec'n)<br>- Change in Work. Capital<br>= Free Cash flow to Firm (FCFE) |
| & A Discount Rate  | <i>Cost of Equity</i><br><ul> <li><i>Basis</i>: The riskier the investment, the greater is the cost of equity.</li> <li><i>Models</i>:<br/>CAPM: Riskfree Rate + Beta (Risk Premium)<br/>APM: Riskfree Rate + <math>\Sigma</math> Beta, (Risk Premium); <math>n</math> factors</li> </ul> | <i>Cost of Capital</i><br>WACC = $k_e$ (E/(D+E))<br>+ $k_d$ (D/(D+E))<br>$k_d$ = Current Borrowing Rate (1 - $t$ )<br>E,D: Mkt Val of Equity and Debt                                                 |                                                                                                                                                |
| & a growth pattern | <p>Stable Growth</p> <p><math>g</math></p> <p><math>t</math></p> <p>High Growth      Stable</p>                                                                                                                                                                                           | <p>Two-Stage Growth</p> <p><math>g</math></p> <p><math>t</math></p> <p>High Growth      Transition      Stable</p>                                                                                    | <p>Three-Stage Growth</p> <p><math>g</math></p> <p><math>t</math></p> <p>High Growth      Transition      Stable</p>                           |
...
= Debt = differentiated prefix company + 
...
| <b>Factor</b>                                     | <b>Factors</b>                                                         | <b>Proposed Question</b>                              |    | <b>Change</b> | <b>Weighting factor</b> | <b>Hydnaldi Heavy</b> | <b>THEAY</b> |
|---------------------------------------------------|------------------------------------------------------------------------|-------------------------------------------------------|----|---------------|-------------------------|-----------------------|--------------|
| Operating Energy                                  | 1. Operating Energy                                                    | Processing resources (with most than 10% of revenues) | No |               | 2.00                    |                       | 6            |
|                                                   | 2. One-time income expenses                                            | Precent of operating income = 0                       |    |               | 0.5                     |                       | 0.5          |
|                                                   | 3. Income from unspecified sources                                     | Precent of operating income = 0                       |    |               | 1.5                     |                       | 1.5          |
| 4. Lives in income statement that are volatile    |                                                                        | Precent of operating income = 0                       |    |               | 5.00                    |                       | 6            |
| Tax Rate                                          | 1. Operating from multiple locals                                      | Processing revenues from non-domestic locals = 0      |    |               | 2.00                    |                       | 2.25         |
|                                                   | 2. Different tax and reporting books                                   | Yes No                                                |    |               | No                      |                       | 0            |
|                                                   | 3. Headquarters in tax haven                                           | Yes No                                                |    |               | No                      |                       | 0.00         |
| 4. Volatile effective tax rate                    |                                                                        | Yes No                                                |    |               | Yes                     |                       | 2            |
| Capital                                           | 1. Volatile capital expenditures                                       | Yes No                                                |    |               | Yes                     |                       | 2            |
|                                                   | 2. Both report and large acquisitions                                  | Yes No                                                |    |               | No                      |                       | 0            |
|                                                   | 3. Stock payment for acquisitions and investments                      | Yes No                                                |    |               |                         |                       | 0            |
| Working capital                                   | 1. Unspecified current assets and current volatilities                 | Yes No                                                |    |               | No                      |                       | 0            |
|                                                   | 2. Volatile working capital items                                      | Yes No                                                |    |               | Yes                     |                       | 3            |
|                                                   | 3. Volatile working capital items                                      | Yes No                                                |    |               | Yes                     |                       | 2            |
| Expected Growth rate                              | 1. Off-balance sheet assets and liabilities (operating leases and R&D) | Yes No                                                |    |               | No                      |                       | 0            |
|                                                   | 2. Expected growth by backs                                            | Yes No                                                |    |               | No                      |                       | 0            |
|                                                   | 3. Changing return on capital over time                                | Yes No                                                |    |               | Yes                     |                       | 5            |
| 4. Unspecified back return                        |                                                                        | Yes No                                                |    |               | Yes                     |                       | 5            |
| Cost of capital                                   | 1. Multiple businesses                                                 | Number of businesses (more than 10% of revenues) = 0  |    |               | 3                       |                       | 1.00         |
|                                                   | 2. Operations in emerging markets                                      | Precent of revenues= 0                                |    |               | 50%                     |                       | 2.5          |
|                                                   | 3. Expected market traded?                                             | Yes No                                                |    |               | No                      |                       | 2            |
| 4. Does the company have a rating?                |                                                                        | Yes No                                                |    |               | No                      |                       | 2            |
| 5. Does the company lavel off-balance sheet debt? |                                                                        | Yes No                                                |    |               | No                      |                       | 0            |
| No-operating assets                               | 1. Minority holdings as percent of book assets                         | Minority holdings as percent of book assets           |    |               | 30%                     |                       | 6            |
|                                                   | 2. Minority holdings as percent of book assets                         | Minority holdings as percent of book assets           |    |               | 30%                     |                       | 6            |
| Furniture to equipment                            |                                                                        | Minority interest as percent of book of equity        |    |               | 20.00                   |                       | 4            |
| Per share value                                   | 1. Subsidiaries with diff                                              |                                                       |    |               |                         |                       |              |
...
|-------------------|--------------|--------------------------------------|
| 1. Con Ed         | Stable DDM   | Stable growth inputs; Implied growth |
| 2a. ABN Amro      | 2-Stage DDM  | Breaking down value; Macro risk?     |
| 2b. Goldman       | 3-Stage DDM  | Regulatory overlay?                  |
| 2c. Wells Fargo   | 2-stage DDM  | Effects of a market meltdown?        |
| 2d. Deutsche Bank | 2-stage FCFE | Estimating cashflows for a bank      |
...
|  | <b>Year</b>           | <b>1-5</b>   | <b>6</b>      | <b>7</b>      | <b>8</b>     | <b>9</b>     | <b>10</b> on... |
|--|-----------------------|--------------|---------------|---------------|--------------|--------------|-----------------|
...
$$P_0 = \left\{ \left[ \sum_{i=1}^{(n)} \frac{DP_{i,t}}{(1+r)^i} + \frac{P_n}{(1+r)^n} \right] - \frac{DPS_0^*(1+g_n)}{(r-g_n)} \right\}^{\frac{1}{n}} + \left\{ \frac{DPS_0^*(1+g_n)}{(r-g_n)} - \frac{DPS_0}{r} \right\}^{\frac{1}{n}} + \frac{DPS_0}{r}$$
Value of High Growth Assets in Place      Value of Stable Growth Place
...
**Normalized Earnings** As a cyclical company, Toyota's earnings have been volatile and 2009 earnings reflect the troubled global economy. We will assume that when economic growth returns, the operating margin for Toyota will revert back to the historical average. 1
...
**Normalized Cost of capital** The cost of capital is computed using the average beta of automobile companies (1.10), and Toyota's cost of debt (3.25%) and debt ratio (52.9%). We use the Japanese marginal tax rate of 40.7% for computing both the after-tax cost of debt and the after-tax operating income Cost of capital = 8.65% (.471) + 3.25% (1-.407) (.529) = 5.09% <sup>3</sup> <sup>4</sup>
...
|                          | Tata Chemicals | Tata Steel | Tata Motors | TCS    |
|--------------------------|----------------|------------|-------------|--------|
| % of production in India | 90%            | 90%        |             |        |
| % of revenues in India   | 75%            | 88.83%     | 91.37%      | 72.03% |
...
- • Cumulative probability of surviving 10 years =  $(1 - .1354)^{10} = 23.34\%$ 
  • Cumulative probability of distress over 10 years =  $1 - .2334 = .7666$  or  $7\%$ 
...
$$529 = \sum_{i=1}^{i=7} \frac{63.75(1-\Pi_{\text{Distress}})^i}{(1.03)^i} + \frac{1000(1-\Pi_{\text{Distress}})^7}{(1.03)^7}$$
...
Assume that you have valued your firm, using a discounted cash flow model and with the all the information that you have available to you at the time. Which of the following

statements about the valuation would you agree with? If I know what I am doing, the DCF valuation will be precise No matter how careful I am, the DCF valuation gives me an estimate If you subscribe to the latter statement, how would you deal with the uncertainty? Collect more information, since that will make my valuation more precise Make my model more detailed Do what-if analysis on the valuation Use a simulation to arrive at a distribution of value Will not buy the company
...
At the time of the valuation, the oil price was \$ 45 a barrel. Exxon's operating income based on thisi price is Normalized Operating Income = -6,395 + 911.32 (\$45) = \$34,614

**Estimate return on capital and reinvestment rate based on normalized income** <sup>1</sup> <sup>2</sup>
...
**Expected growth in operating income** Since Exxon Mobile is the largest oil company in the world, we will assume an expected growth of only 2% in perpetuity.

**Exxon's cost of capital** Exxon has been a predominantly equtiy funded company, and is explected to remain so, with a deb ratio of onlly 2.85%: It's cost of equity is 8.35% (based on a beta of 0.90) and its pre-tax cost of debt is 3.75% (given AAA rating). The marginal tax rate is 38%.
