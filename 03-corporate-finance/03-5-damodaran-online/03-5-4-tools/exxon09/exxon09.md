...
source_url: https://www.stern.nyu.edu/~adamodar/pc/eqegs/exxon09.xls
---

# Exxon09

Source: https://www.stern.nyu.edu/~adamodar/pc/eqegs/exxon09.xls

Sheets: Sheet2, NewFCFFStableGrowth

## Sheet2

| Normalized Oil Price | Value per share |
|---|---|
| 20 | 22.29 |
| 25 | 31.73 |
| 30 | 41.17 |
...
| Normalized Operating Income (do not input) |
| Current tax rate = |
|  |
| Capital Expenditures |
| Depreciation = |
| Change in Working Capital = |
| Do you want to change the current reinvestment numbers? |
| If so, enter return on capital in perpetuity  |
|  |
| Current price per share = |
| Number of shares outstanding = |
| Debt outstanding = |
| Resulting debt ratio (do not input)= |
