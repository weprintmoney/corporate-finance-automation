---
title: "Baidudividends"
status: active
owner: weprintmoney
created: 2026-09-02
last_updated: 2026-09-02
source_url: http://www.stern.nyu.edu/~adamodar/pc/acf4E/BaiduDividends.xls
---

# Baidudividends

Source: http://www.stern.nyu.edu/~adamodar/pc/acf4E/BaiduDividends.xls

Sheets: Read me first, Inputs, Analysis of past dividends, Forecasted Dividends & FCFE, Historical Stock and T.Bills, Annual return worksheet, Sheet1
...
|  |
| Enter the following data for the years for which you have data (starting with most recent year and working backwards) |
| Year |
| 1 |
| 2 |
| 3 |
...
| 0 |
|  |
| Enter the dollar dividends paid and equity repurchases for each year of historical data (staring with most recent year and working backwards): (Equity repurchases are in the statement of cash flows) |
| Year |
| 1 |
| 2 |
| 3 |
...
|  |
| Enter the following data relating to performance (starting with most recent year and working backwards)): (Make sure that you update the riskfree rate and return on the market from the attached worksheet to reflect the time period for your data) |
| Year |
| 1 |
| 2 |
| 3 |
