...
source_url: https://www.stern.nyu.edu/~adamodar/pc/inv3ed/volkswagen.xls
---

# Volkswagen

Source: https://www.stern.nyu.edu/~adamodar/pc/inv3ed/volkswagen.xls
...
| Current Non-cash Net Income = |
|  |
| Capital Spending = |
| Depreciation = |
| Cash balance = |
| Chg. Working Capital = |
| Debt financing ratio last year = |
| Do you want to offset capital expenditures by depreciation in the future? |
| The reinvestment rate based upon your inputs is computed to be |
| Do you want to recompute this reinvestment rate based upon fundamentals? |
| If yes, enter the return on equity that you expect this firm to have in perpetuity |
