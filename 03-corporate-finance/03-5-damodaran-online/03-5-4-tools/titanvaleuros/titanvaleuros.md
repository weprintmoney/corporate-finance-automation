...
source_url: https://www.stern.nyu.edu/~adamodar/pc/country/titanvalEuros.xls
---

# Titanvaleuros

Source: https://www.stern.nyu.edu/~adamodar/pc/country/titanvalEuros.xls

Sheets: Read me first, Master Inputs Start here, Earnings Normalizer, R&D converter, Operating lease converter, What-if, Valuation Model, Option Value, Bottom-up Beta, Ratings estimator, Industry averages
...
| Enter the exchange rate for the conversion (input/foreign) |
| Current EBIT = |
