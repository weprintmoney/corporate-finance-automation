...
source_url: http://pages.stern.nyu.edu/~adamodar/New_Home_Page/datafile/divreg25.htm
---
...
/\* List Definitions \*/
@list l0
{mso-list-id:235287860;
mso-list-type:hybrid;
mso-list-template-ids:-2113107622 -1432572654 38798256 -1305692264 -1310844848 -35633092 1947502636 -1966169630 -875768462 -257808690;}
@list l0:level1
...
font-family:Symbol;}
@list l1
{mso-list-id:359939218;
mso-list-type:hybrid;
mso-list-template-ids:-307456118 945051906 621968928 505711708 838742414 1726413716 -407894472 15354622 -1968420728 -314391298;}
@list l2
{mso-list-id:2009091633;
mso-list-type:hybrid;
mso-list-template-ids:46582378 -643034124 -88444458 -1202448018 -104949656 985976996 -775153532 -16763206 -780773508 -2080338352;}
@list l2:level1
{mso-level-number-format:bullet;
mso-level-text:\F0B7;
mso-level-tab-stop:.5in;
...
mso-bidi-theme-font:minor-bidi;
mso-fareast-language:JA;}
p.MsoNormal921 {mso-style-unhide:no;
mso-style-qformat:yes;
mso-style-parent:"";
margin-top:0in;
margin-right:0in;
...
## Dividend Regressions: January 2025
...
 
![](../Budimage/YldUSPart1.jpeg)

 

### Regression Output

![](../Budimage/YldUSPart22.jpeg)
...
 
![](../Budimage/PayoutUSPart1.jpeg)

### Regression Output

![](../Budimage/PayoutUSPart2.jpeg)
...
 
![](../Budimage/YldGlobalPart1.jpeg)

 

### Regression Output

![](../Budimage/YldGlobalPart2.jpeg)

**Global Regression: Dividend Payout**

 
![](../Budimage/PayoutGlobalPart1.jpeg)

 

### Regression Output

![](../Budimage/PayoutGlobalPart2.jpeg)
...
Assume
that you want to estimate the dividend yield for a firm with the following
...
If your
predicted value is less than zero, your predicted dividend yield is
zero.
