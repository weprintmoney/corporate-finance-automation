...
• The  R squared (R2) of the regression provides an estimate
of the proportion of the risk (variance) of a firm that can be
attributed to market risk.  The balance (1 - R2) can be
...
o Shorter periods can be affected more easily by significant firm-specific event that

occurred during the period.

• Decide on a return interval – daily, weekly, monthy
...
• Choose a market index, and estimate returns (inclusive of dividends) on the index for

each interval for the period.
...
o Price for Disney at end of November 2009 = $ 30.22
o Price for Disney at end of December 2009 = $ 32.25
o Dividends during month =  $0.35 (It was an ex-dividend month)
o Return =($32.25 - $30.22 + $ 0.35)/$30.22= 7.88%
...
o Index level at end of December 2009 = 1115.10
...
o This is an intercept based on monthly returns. Thus, it has to be compared to a monthly riskfree
...
o Intercept versusRiskfree Rate (1 - Beta)

o 0.712% versus0.0105%

o Jensen’s Alpha = 0.7122% - (-0.0105)% = 0.723%
...
o Annualized, Disney’s annual excess return = (1.00723)12 -1= 9.02%
...
• Regression parameters are always estimated with error. The error
is captured in the standard error of the beta estimate, which in the
case of Disney is 0.10.
...
• The R-squared for companies, globally, has increased significantly

since 2008. Why might this be happening?
...
1.25
2.75% (U.S. ten-year T-Bond rate in
November 2013)
5.76% (Based on Disney’s operating
exposure)
...
• As a potential investor in Disney, what does this expected return of 9.95%

tell you?
o This is the return that I can expect to make in the long term on Disney,
if the stock is correctly priced and the CAPM is the right model for risk,

o This is the return that I need to make on Disney in the long term to
...
suggests that an investment in Disney will yield 12.5% a year for the next
5 years. Based upon the expected return of 9.95%, you would
o Buy the stock
o Sell the stock
...
o this is the hurdle rate for projects, when the investment

is analyzed from an equity standpoint
...
If you can get a beta regression page (or output) for your company against a
market index, answer the following questions:

o How well or badly did your stock do, relative to the market, during the period
...
o What proportion of the risk in your stock is attributable to the market? What

proportion is firm-specific?

o What is the historical estimate of beta for your stock? What is the range on

this estimate with 67% probability? With 95% probability?

o Based upon this beta, what is your estimate of the required return on this
